...
CAMPAIGN_FEATURES = (
    ...
    CampaignFeature('mutational scan', lambda settings: bool(settings.get('binder_sequences')), shorthand='scan', switch='binder_sequences',
                    checks=(ModalityCheck('Binder_Mutations', 0.0, True, parameters=mutation_check_parameters),),  #recorded, never rejecting: an unchanged parent is caught in the mutate stage itself
